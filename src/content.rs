...
pub fn Content() -> impl IntoView {
    view! {
        <body class="flex overflow-x-scroll flex-row font-serif h-dvh w-dvw snap-x snap-mandatory bg-base-a text-base-e">
            <div
                id="summary"
            ...
            >
                <section
                    id="pharetra"
                    class="p-1 my-3 target:bg-base-b rounded-1"
                >
                    <p>
