...
pub fn Content() -> impl IntoView {
    mview! {
        body class="h-dvh w-dvw flex flex-row overflow-x-scroll snap-x snap-mandatory  bg-src-900 text-src-300 font-serif" (
            ...
            div #exposition class="h-full py-[50vh] w-1/2 shrink-0 snap-center overflow-y-scroll overscroll-y-contain" (
                section id="pharetra" class="border-src-350 target:bg-src-800 m-4 rounded-md border p-4" (
                ...
                section id="nullam" class="border-src-350 target:bg-src-800 m-4 rounded-md border p-4" (
            ...
            div #details class="h-full py-[50vh] w-1/2 shrink-0 snap-center mr-[50%] overflow-y-scroll overscroll-y-contain" (
                aside id="saggitis" class="border-src-350 target:bg-src-800 m-4 rounded-md border p-4" (
