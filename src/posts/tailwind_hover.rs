    ...
    view! {
        ...
        <p>
            r##"
                ...
                where the hover state would activate after interacting,
                and persist until the next interaction.
            "##
        </p>
        <p>
            r##"
                However, the exemption is over-broad, disabling hover
                for various devices where hover is expected to work -
                tablets, touchscreen laptops, Safari Technology Preview on my MacBook Pro.
            "##
        </p>
        <p>
            r##"
